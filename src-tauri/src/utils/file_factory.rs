...
pub fn get_clipboard_files() -> Vec<(String, String)> {
    ...
    unsafe {
        ...
        let classes = vec![Class::get("NSURL").unwrap() as *const _ as *mut Object];

        let objects =
            pasteboard.readObjectsForClasses_options(NSArray::arrayWithObjects(nil, &classes), nil);
